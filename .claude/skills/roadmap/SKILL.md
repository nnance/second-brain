---
name: roadmap
description: Manage the roadmap for this project. Use this skill to add features, prioritize them, and move them through the workflow stages (Backlog → Designing → In Progress → Review → Completed).
---
